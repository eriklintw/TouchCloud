        ...
        <div id="wrapper">
            ...
            <script>
                $(document).ready(function () {
                    var thisTable = $('#dataTables-example').DataTable({
                        responsive: true,
                    });

                    $.ajax({
                        type: 'GET',
                        url: '${pageContext.request.contextPath}/powerStatus/',
                        success: function (result) {
                            debugger;
                            $.each(result, function (i, data) {
                                debugger;
                                var row = $('<tr></tr>');
                                row.append($('<td></td>').text(data.address));
                                row.append($('<td></td>').text(data.manufacturerId));
                                row.append($('<td></td>').text(data.batteryLevel));
                                row.append($('<td></td>').text(data.majorId));
                                row.append($('<td></td>').text(data.minorId));
